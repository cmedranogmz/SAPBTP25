CLASS zcmg_cl_aux_travel DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES: tt_travel_reported    TYPE TABLE FOR REPORTED zcmg_i_travel,
           tt_booking_reported   TYPE TABLE FOR REPORTED zcmg_i_booking,
           tt_booksuppl_reported TYPE TABLE FOR REPORTED zcmg_i_booksuppl.
...
CLASS zcmg_cl_aux_travel IMPLEMENTATION.
